...
const handleCheckOut = async () => {
  ...
  const calculateWorkedHours = () => {
    if (!attendance?.checkIn) {
      // return "-"; // No check-in
       return "00 hrs 00 min"; // No check-in
    }
                ...
                <div className="card shadow-sm h-100 border-0">
                  <div className="card-body d-flex justify-content-between align-items-center">
                    ...
                    <div style={{ color: "#3A5FBE", fontSize: "25px" }}>
                      ...
                      <p className="mb-1 ms-2" style={{ color: "#3A5FBE", fontSize: "18px", fontWeight: 500 }}>{user.casualLeaveBalance} Days Casual Leave</p>
                      <p className="mb-0 ms-2" style={{ color: "#3A5FBE", fontSize: "18px", fontWeight: 500 }}>{user.sickLeaveBalance} Days Sick Leave </p>
                    </div>
