...
function MyProfile({ user }) {
  ...
  return (
    <div className="container-fluid p-3 p-md-4 p-2">
      <div
        className="card shadow-sm border-0 rounded"
        style={{ maxWidth: "1200px", margin: "0 auto" }}
      >
        {/* Header: Image + Name + Buttons */}
        <div className="d-flex flex-column flex-md-row align-items-md-center justify-content-between p-2 p-md-3 gap-3">
          {/* ================= IMAGE , NAME (TOP SECTION) ================= */}
          <div
            className={`d-flex gap-2 gap-md-3 w-100 w-md-auto ${
              isEditing
          ...
          >
            <div className="d-flex flex-column align-items-center text-center">
              <label className="form-label fw-semibold text-primary mb-2 d-none d-md-block">
                Profile Image
              </label>
          ...
          <div className="d-flex gap-2 w-100 w-md-auto justify-content-end mt-2 mt-md-0">
            {!isEditing ? (
              <button
