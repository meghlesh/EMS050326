...
const AddEmployee = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("https://api-tmsdev-be-ede3ccg8dxd3awbw.southindia-01.azurewebsites.net/admin/add-employee", payload, {
    ...
    <>
      ...
      {showModal && (
        ...
        style={{display: "flex",
                ...
                position: "fixed",
                inset: 0,
                zIndex: 1050, overflow: "auto", }}>
          <div  className="modal-dialog  "
          style={{ maxWidth: "700px",marginTop:"120px" }}>
