    ...
    if (!stateEmployee) {
      const fetchEmployee = async () => {
        try {
          ...
          const res = await axios.get(`https://api-tmsdev-be-ede3ccg8dxd3awbw.southindia-01.azurewebsites.net/getEmployee/${empId}`, {
...
case "uanNumber":
  ...
  if (new Date(dob) > minDate) {
    ...
    try {
      ...
      await axios.put(`https://api-tmsdev-be-ede3ccg8dxd3awbw.southindia-01.azurewebsites.net/employees/${employee._id || empId}`, data, {
      ...
      const updated = await axios.get(`https://api-tmsdev-be-ede3ccg8dxd3awbw.southindia-01.azurewebsites.net/getEmployee/${employee._id || empId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
