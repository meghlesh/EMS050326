              ...
              >
                ...
                <div className="col-12 col-md-auto d-flex align-items-center gap-2 mb-1 ms-2">
                  <label htmlFor="statusFilter" className="fw-bold mb-0 "
                    style={{ width: "50px", minWidth: "50px", fontSize: "16px", color: "#3A5FBE",}}>Status</label>
                  <select
                    id="statusFilter"
                ...
                <div className="col-12 col-md-auto d-flex align-items-center gap-2 mb-1 ms-2">
                  <label htmlFor="employeeNameFilter" className="fw-bold mb-0 text-start text-md-end"
                    style={{ width: "50px",minWidth: "50px", fontSize: "16px", color: "#3A5FBE",  }}>Name</label>
                  <input
                ...
                <div className="col-12 col-md-auto d-flex align-items-center gap-2 mb-1 ms-2">
                  <label htmlFor="dateFromFilter" className="fw-bold mb-0 text-start text-md-end"
                    style={{ fontSize: "16px", color: "#3A5FBE", width: "50px", minWidth: "50px",  }}>From</label>
                  <input
                    type="date"
                    id="dateFromFilter"
                    className="form-control"
    ...
    `}
                  ...
                  <div className="col-12 col-md-auto d-flex align-items-center gap-2 mb-1 ms-2">
                    <label
                      ...
                      style={{ fontSize: "16px", color: "#3A5FBE", width: "50px", minWidth: "50px", }}
                    >
                      To
                    </label>
                    <input
